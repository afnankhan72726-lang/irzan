...
namespace CitrioN.Common.Editor
{
  public class ListFromScriptableObjectItemDataCreator<T> where T : ScriptableObjectItemData
  {
    ...
    protected virtual void BindListItem(VisualElement elem, int index)
    {
      ...
      UIToolkitUtilities.SetText(elem.Q<Label>(className: itemDisplayNameLabelClass), item.DisplayName);
      UIToolkitUtilities.SetText(elem.Q<Label>(className: itemDescriptionNameLabelClass), item.Description);
    }
  }
}